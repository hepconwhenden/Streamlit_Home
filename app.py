...
st.write("⚠️「😴Zzzz This app has gone to sleep due to inactivity. Would you like to wake it back up?」と表示される場合、「Yes, get this app back up!」ボタンをおして再起動してください。")
...
apps = [
    ...
    },
    {
        "title": "デジタル印鑑を押そう！",
        "description": "ジョークアプリ",
        "url": "https://hepconw-henden-app6.streamlit.app/"
    }
]
